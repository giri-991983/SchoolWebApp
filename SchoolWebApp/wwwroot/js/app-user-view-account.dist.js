...
$(function () {
  ...
  if (dt_project_table.length) {
    var dt_project = dt_project_table.DataTable({
      ...
      order: [[1, 'desc']],
      dom: '<"card-header d-flex flex-wrap row-gap-5"<"project-head-label"><" text-end pt-0 my-n5"f>>+t',
      displayLength: 7,
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-toggle="tooltip" title="Delete Invoice"><i class="ri-delete-bin-7-line ri-22px"></i></a>' +
              '<a href="/Apps/Invoice/Preview" class="btn btn-sm btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-toggle="tooltip" title="Preview"><i class="ri-eye-line ri-22px"></i></a>' +
      ...
      order: [[1, 'desc']],
      dom: '<"card-header d-flex"<"head-label"><"dt-action-buttons text-end pt-0"B>>+t<"row mx-5 row-gap-2"<"col-sm-12 col-xxl-6 pe-5"i><"col-sm-12 col-xxl-6"p>>',
      displayLength: 7,
      language: {
        sLengthMenu: 'Show _MENU_',
        search: '',
      ...
      buttons: [
        {
          ...
          text: '<i class="ri-external-link-line me-2"></i>Export',
          buttons: [
            {
              extend: 'print',
